...
const CATALOG = [
  ...
  { slug: "lxgw-wenkai-tc", family: "LXGW WenKai TC", category: "handwriting", langs: ["zh-Hant", "latin"], weights: [300, 400, 700], fallback: '"Kaiti TC", "DFKai-SB", serif', gfFamily: "LXGW WenKai TC", gfWeights: [300, 400, 700] }, // 霞鶩文楷 TC：Google Fonts 有（動態子集、免上傳）
