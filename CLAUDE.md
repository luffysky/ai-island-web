...
- **目前進度：~1049 條 / 目標 5000。續寫從 `dictionary-seed-22.json` 接下去編號**（別重複既有 slug；批次主題見各 commit 訊息）。**「續辭典」= 從第 22 批繼續 author→import→commit→push。**（21 批＝工程實務術語：async/await、debounce/throttle、canary、rollback、YAGNI/KISS…共 27 條）
