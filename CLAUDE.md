...
7. **全部沒問題 → 先更新工作日誌（`docs/worklog/daily_works_*.md`）→ 再 commit / push。** 完成的 todo 用刪除線標記、不要刪。（待辦統一寫 `docs/todo/todo_list_0723.md`＝**現行主檔**，0721 整合全部舊 todo 檔並核對、0722 續用更新；`todo_list_0721/0715/0714/0713.md` 等全部留作歷史，見檔末〈附錄 A〉）
