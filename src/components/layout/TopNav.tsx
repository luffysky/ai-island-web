...
const NAV_LINKS = [
  ...
  { href: "/works", key: "works", icon: Images },
...
export function TopNav() {
  ...
  return (
    <nav data-tour="topnav" className="sticky top-0 z-40 bg-bg/60 supports-[backdrop-filter]:bg-bg/45 backdrop-blur-xl backdrop-saturate-150 border-b border-border/70">
      ...
      {mobileMenu && (
        <div className="md:hidden animate-slide-in-left origin-left border-t border-border/50 bg-gradient-to-b from-bg/80 to-bg/45 supports-[backdrop-filter]:from-bg/50 supports-[backdrop-filter]:to-bg/15 backdrop-blur-2xl backdrop-saturate-150 px-3 pt-3 pb-[calc(1rem+env(safe-area-inset-bottom))] max-h-[calc(100dvh-3.5rem)] overflow-y-auto overscroll-contain">
