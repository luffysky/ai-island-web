  ...
  return (
    ...
    >
      <div className={`bg-gradient-to-br ${RARITY_COLORS[achievement.rarity] ?? RARITY_COLORS.common} rounded-xl p-1`}>
        <div className="bg-[var(--color-bg-elevated)] rounded-[10px] p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-[var(--color-fg-muted)] mb-2">{achievement.description}</div>
              <div className="flex gap-2 text-xs">
                {achievement.xp_reward > 0 && <span className="text-[var(--color-warning)]">+{achievement.xp_reward} XP</span>}
