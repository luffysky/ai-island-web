...
export function CareerPathSection() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      <h2 className="text-3xl font-bold mb-2 inline-flex w-full items-center justify-center gap-2 reveal"><Target size={28} /> 選一條職業路線</h2>
      <p className="text-center text-fg-muted mb-10 reveal">不用全 {SITE_STATS.chapterCount} 章—鎖定目標、走最短路徑、最快上場</p>
