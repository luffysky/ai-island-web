    ...
    <section className="border-b border-[var(--color-border)] py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-[var(--color-fg-muted)]">三種力量、一個目標、陪你走完冒險旅程</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-5 rounded-xl border border-orange-400/30 bg-orange-400/5">
            ...
            <div className="text-sm text-[var(--color-fg-muted)] mb-2">衝鋒隊長 · 行動派先鋒</div>
          ...
          <div className="p-5 rounded-xl border border-purple-400/30 bg-purple-400/5">
            ...
            <div className="text-sm text-[var(--color-fg-muted)] mb-2">策略軍師 · 冷靜分析</div>
            <p className="text-sm leading-relaxed">
          ...
          <div className="p-5 rounded-xl border border-green-400/30 bg-green-400/5">
            ...
            <div className="text-sm text-[var(--color-fg-muted)] mb-2">AI 精靈 · 創造無限</div>
            <p className="text-sm leading-relaxed">
