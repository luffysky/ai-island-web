...
import { ExternalLink, BookOpen, Youtube, Newspaper, GraduationCap, Wrench, Users, Mic, FileText, Globe, Gamepad2 } from "lucide-react";
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap mb-0.5">
                  ...
                  {r.curated_by === "xueyue" && <span className="text-[10px] chip chip-info">✨ 雪鑰精選</span>}
                  {r.source && <span className="text-[10px] text-fg-muted">📍 {r.source}</span>}
                </div>
