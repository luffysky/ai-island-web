      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button onClick={resetLevel} className="inline-flex items-center gap-1 px-3 py-2 rounded-full border border-border text-sm text-fg-muted hover:text-fg"><RotateCcw size={14} /> 清空</button>
          ...
          {msg && <div className={`text-sm rounded-xl px-3 py-2 whitespace-pre-wrap ${msg.type === "ok" ? "bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-300" : "bg-red-500/10 border border-red-500/30 text-red-600 dark:text-red-300"}`}>{msg.text}</div>}
