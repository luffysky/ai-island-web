            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {hasOverride && <span className="inline-flex items-center gap-1 text-xs px-1.5 py-0.5 bg-green-500/20 text-green-900 dark:text-green-200 rounded"><Check size={12} /> 已設定</span>}
                </div>
