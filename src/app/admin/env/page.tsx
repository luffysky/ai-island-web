...
const SECRET_GROUPS: EnvGroup[] = [
  ...
  {
    title: "LINE User bot（使用者個人通知用、跟 admin bot 分開）",
    emoji: "🌱",
    vars: [
      { key: "USER_LINE_CHANNEL_TOKEN", description: "User bot Messaging API token" },
      { key: "USER_LINE_CHANNEL_SECRET", description: "User bot Messaging API secret" },
      { key: "NEXT_PUBLIC_USER_LINE_BOT_BASIC_ID", description: "User bot @basicId（client 加好友 deeplink）" },
      { key: "LINE_CHANNEL_ID", description: "LINE Login channel ID" },
      { key: "NEXT_PUBLIC_LINE_CHANNEL_ID", description: "LINE Login channel ID（client）" },
      { key: "LINE_CHANNEL_SECRET", description: "LINE Login channel secret" },
    ],
  },
  {
