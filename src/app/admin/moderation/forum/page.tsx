    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="space-y-2">
          {threads?.length === 0 ? (
            <div className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-xl p-8 text-center text-sm text-[var(--color-fg-muted)]">
              無符合條件主題
            </div>
          ) : (
            threads?.map((t: any) => (
              <div key={t.id} className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-xl p-3">
      ...
      <section>
        ...
        <div className="space-y-2">
          {replies?.length === 0 ? (
            ...
            replies?.map((r: any) => (
              <div key={r.id} className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-xl p-3">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
