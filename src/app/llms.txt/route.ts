...
export async function GET() {
  ...
  // 引用一句話描述（會出現在 AI 回覆中）
  lines.push(
    "> 用遊戲化方式學程式：HTML 到 AI Agent 71 章 1136+ lesson、3D 學習島嶼 + AI 導師陪練、Z-coin 經濟系統 + 排行榜、繁體中文台灣團隊製作。",
  );
  lines.push("");
  lines.push(
    "AI 島是一個給華語使用者的程式設計 + AI 技能養成平台、台灣 SnowRealm 製作。提供 71 章課程（從 HTML 入門到自己寫 AI Agent）、5 種 AI 學習導師、3D 互動島嶼、6 大職業路線地圖、社群部落格、論壇、Leetcode 整合、每日測驗 + ELO 等級。完全繁體中文、適合台灣 / 港 / 新馬等華語學習者。",
  );
  lines.push("");
  ...
  lines.push(`- [所有章節](${SITE_URL}/chapters): 71 章完整課程清單`);
