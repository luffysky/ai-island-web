  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-5">
      <header className="flex items-center justify-between">
        <h1 className="text-2xl font-bold inline-flex items-center gap-2"><Users size={22} /> {t("friendsTitle")}</h1>
        <Link href="/creator-island/community" className="text-sm text-accent hover:underline">← {t("friendsBackToCommunity")}</Link>
      </header>
